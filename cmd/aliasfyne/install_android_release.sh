...
(cd $GOPATH/src/aletheiaware.com/aliasfynego/cmd/aliasfyne && fyne release -os android -appID com.aletheiaware.alias -appBuild 1 -appVersion 1.1.7 -keyStore=$GOPATH/src/aletheiaware.com/aliasfynego/private/Alias.keystore -name Alias)
